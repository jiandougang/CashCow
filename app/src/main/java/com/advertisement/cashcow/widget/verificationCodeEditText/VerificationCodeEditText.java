package com.advertisement.cashcow.widget.verificationCodeEditText;
...
public class VerificationCodeEditText extends android.support.v7.widget.AppCompatEditText implements
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mFigures = ta.getInteger(R.styleable.VerificationCodeEditText_figures, 4);
        mVerCodeMargin = (int) ta.getDimension(R.styleable.VerificationCodeEditText_verCodeMargin, 0);
        mBottomSelectedColor = ta.getColor(R.styleable.VerificationCodeEditText_bottomLineSelectedColor,
                getCurrentTextColor());
        mBottomNormalColor = ta.getColor(R.styleable.VerificationCodeEditText_bottomLineNormalColor,
                getColor(android.R.color.darker_gray));
        mBottomLineHeight = ta.getDimension(R.styleable.VerificationCodeEditText_bottomLineHeight,
                dp2px(5));
        mSelectedBackgroundColor = ta.getColor(R.styleable.VerificationCodeEditText_selectedBackgroundColor,
                getColor(android.R.color.darker_gray));
        ta.recycle();
